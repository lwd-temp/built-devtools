...
import { type CanShowSurveyResult, type ContextMenuDescriptor, type DoAidaConversationResult, type EnumeratedHistogram, type EventTypes, type ExtensionDescriptor, type InspectorFrontendHostAPI, type LoadNetworkResourceResult, type ShowSurveyResult, type SyncInformation } from './InspectorFrontendHostAPI.js';
