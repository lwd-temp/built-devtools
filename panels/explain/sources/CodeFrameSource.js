...
export class CodeFrameSource {
    ...
    getAnchor() {
        ...
        return new AnchorBox(leftCorner.left, leftCorner.top, rightCorner.right - leftCorner.left, rightCorner.bottom - leftCorner.top);
    }
    async getPrompt() {
...
//# sourceMappingURL=CodeFrameSource.js.map