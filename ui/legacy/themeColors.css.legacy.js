...
:root {
  ...
  --app-color-selected: var(--ref-palette-primary80);
  --app-border-selected: var(--ref-palette-primary70);
}
...
.-theme-with-dark-background {
  ...
  --app-color-selected: var(--ref-palette-secondary40);
  --app-border-selected: var(--ref-palette-secondary50);
}
`
};
